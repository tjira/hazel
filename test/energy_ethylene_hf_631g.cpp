...
int test_energy_ethylene_hf_631g(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -78.00394203061691 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E - -78.00394203061691) > 1e-8;
}
