...
struct Lambda {
    ...
    static std::function<std::tuple<double, Matrix>(System&)> EGCI(const HF::OptionsRestricted& rhfopt, const CI::OptionsRestricted& rciopt, const std::vector<double>& gopt, Matrix D);
    ...
    // energy functions
    static std::function<double(System)> ECI(const HF::OptionsRestricted& rhfopt, const CI::OptionsRestricted& rciopt, Matrix D);
