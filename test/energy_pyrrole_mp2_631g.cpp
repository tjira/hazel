...
int test_energy_pyrrole_mp2_631g(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -209.18941494316837 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E + data.mp.Ecorr - -209.18941494316837) > 1e-8;
}
