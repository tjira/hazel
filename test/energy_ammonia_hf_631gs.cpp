...
int test_energy_ammonia_hf_631gs(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -56.18194343801460 << std::endl;

    // return success or failure based on the error
    return std::abs(data.hf.E - -56.18194343801460) > 1e-8;
}
