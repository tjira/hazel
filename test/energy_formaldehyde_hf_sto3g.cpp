...
int test_energy_formaldehyde_hf_sto3g(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -112.35434714216120 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E - -112.35434714216120) > 1e-8;
}
