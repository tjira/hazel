...
int test_energy_ethanol_mp2_sto3g(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -152.27427697789008 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E + data.mp.Ecorr - -152.27427697789008) > 1e-8;
}
