...
int test_energy_water_hf_631gs(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -76.00679980233886 << std::endl;

    // return success or failure based on the error
    return std::abs(data.hf.E - -76.00679980233886) > 1e-8;
}
