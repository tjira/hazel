...
int test_energy_formaldehyde_hf_ccpvdz(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -113.87495844242787 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E - -113.87495844242787) > 1e-8;
}
