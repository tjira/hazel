...
int test_energy_mp2_ammonia_ccpvdz(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -56.38485194729179 << std::endl;

    // return success or failure based on the error
    return std::abs(rhfres.E + Ecorr - -56.38485194729179) > 1e-8;
}
