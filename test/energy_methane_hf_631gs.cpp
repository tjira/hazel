...
int test_energy_methane_hf_631gs(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -40.19517074954842 << std::endl;

    // return success or failure based on the error
    return std::abs(data.hf.E - -40.19517074954842) > 1e-8;
}
