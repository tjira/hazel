...
int test_energy_formaldehyde_hf_631gs(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -113.86411147060667 << std::endl;

    // return success or failure based on the error
    return std::abs(data.hf.E - -113.86411147060667) > 1e-8;
}
