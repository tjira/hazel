...
int test_energy_pyrrole_hf_mini(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -207.13578893098091 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E - -207.13578893098091) > 1e-8;
}
