...
int test_energy_acetone_hf_ccpvdz(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -191.97513081103071 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E - -191.97513081103071) > 1e-8;
}
