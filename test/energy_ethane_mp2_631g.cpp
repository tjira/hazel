...
int test_energy_ethane_mp2_631g(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -79.38752374858753 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E + data.mp.Ecorr - -79.38752374858753) > 1e-8;
}
