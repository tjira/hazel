...
int test_energy_formaldehyde_hf_631g(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -113.80762059286198 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E - -113.80762059286198) > 1e-8;
}
