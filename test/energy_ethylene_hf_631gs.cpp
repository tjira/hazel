...
int test_energy_ethylene_hf_631gs(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -78.03145105205019 << std::endl;

    // return success or failure based on the error
    return std::abs(data.hf.E - -78.03145105205019) > 1e-8;
}
