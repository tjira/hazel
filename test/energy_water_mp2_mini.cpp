...
int test_energy_water_mp2_mini(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -75.49944113287057 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E + data.mp.Ecorr - -75.49944113287057) > 1e-8;
}
