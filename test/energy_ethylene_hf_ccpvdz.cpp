...
int test_energy_ethylene_hf_ccpvdz(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -78.03981979323336 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E - -78.03981979323336) > 1e-8;
}
