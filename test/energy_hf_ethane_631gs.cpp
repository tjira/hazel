...
int test_energy_hf_ethane_631gs(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -79.22865329797463 << std::endl;

    // return success or failure based on the error
    return std::abs(rhfres.E - -79.22865329797463) > 1e-8;
}
