...
int test_energy_pyrrole_mp2_ccpvdz(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -209.53469265715967 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E + data.mp.Ecorr - -209.53469265715967) > 1e-8;
}
