...
int test_energy_ammonia_mp2_631gs(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -56.35669339404529 << std::endl;

    // return success or failure based on the error
    return std::abs(data.hf.E + data.mp.Ecorr - -56.35669339404529) > 1e-8;
}
