...
int test_energy_methane_mp2_321g(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -40.07687501752372 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E + data.mp.Ecorr - -40.07687501752372) > 1e-8;
}
