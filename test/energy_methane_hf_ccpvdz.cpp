...
int test_energy_methane_hf_ccpvdz(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -40.19854469865418 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E - -40.19854469865418) > 1e-8;
}
