...
int test_energy_hf_ammonia_ccpvdz(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -56.19421058506897 << std::endl;

    // return success or failure based on the error
    return std::abs(rhfres.E - -56.19421058506897) > 1e-8;
}
