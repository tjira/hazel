...
int test_energy_pyrrole_mp2_mini(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -207.40154467958169 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E + data.mp.Ecorr - -207.40154467958169) > 1e-8;
}
