...
int test_energy_water_mp2_ccpvdz(int, char**) {
    ...
    std::cout << std::fixed << std::setprecision(14) << "EXPECTED ENERGY: " << -76.22985471489328 << std::endl;

    // return success or failure based on the error
    return std::abs(data.roothaan.E + data.mp.Ecorr - -76.22985471489328) > 1e-8;
}
